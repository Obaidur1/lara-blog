            ...
            <div class="bg-white  relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div
                        ...
                        <button type="button"
                            class="flex items-center justify-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2  focus:outline-none ">
                        ...
                        <tbody>
                            @forelse ($blogs as $blog)
                                <tr class="border-b ">
                                    ...
                                    <td class="px-4 py-3"><img height="64px" width="64px"
                                            src="{{ asset('storage/' . $blog->featured) }}" alt=""
                                            srcset="">
                                    </td>
                                    <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap ">
                                        {{ $blog->title }}</th>

                                    <td class="px-4 py-3">{{ ucfirst($blog->category->name) }}</td>
                                    <td class="px-4 py-3">{{ $blog->user->name }}</td>
                                    <td class="px-4 py-3">{{ ucfirst($blog->views) }}</td>

                                    <td class="px-4 py-3 ">
                                        <button class="underline hover:text-indigo-700"
                                            onclick="Livewire.dispatch('openModal', { component: 'edit-post-modal',arguments:{id:{{ $blog->id }}} })">Edit
                                            Blog</button>
                                    </td>
                                </tr>
                            @empty
