...
<div id="overlay">
    <div id="modal">
        <p id="successMessage" style="color: green;">Comment submitted successfully!</p>
    </div>
</div>
<section class="container mx-auto bg-white py-8 lg:py-16 ">
        ...
        fetch('/comment', {
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    message.innerText = "Comment submit failed!";
